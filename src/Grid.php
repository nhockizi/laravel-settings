...
use Kizi\Settings\Grid\Column;
use Kizi\Settings\Grid\Displayers\Actions;
use Kizi\Settings\Grid\Displayers\RowSelector;
use Kizi\Settings\Grid\Exporter;
use Kizi\Settings\Grid\Filter;
use Kizi\Settings\Grid\Model;
use Kizi\Settings\Grid\Row;
use Kizi\Settings\Grid\Tools;
...
class Grid
{
    ...
    public function __construct(Eloquent $model, Closure $builder)
    {
        ...
        $this->columns = new IlluminateCollection();
        $this->rows    = new IlluminateCollection();
    ...
    {
        $map = [
            'editable'    => \Kizi\Settings\Grid\Displayers\Editable::class,
            'switch'      => \Kizi\Settings\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Kizi\Settings\Grid\Displayers\SwitchGroup::class,
            'select'      => \Kizi\Settings\Grid\Displayers\Select::class,
            'image'       => \Kizi\Settings\Grid\Displayers\Image::class,
            'label'       => \Kizi\Settings\Grid\Displayers\Label::class,
            'button'      => \Kizi\Settings\Grid\Displayers\Button::class,
            'link'        => \Kizi\Settings\Grid\Displayers\Link::class,
            'badge'       => \Kizi\Settings\Grid\Displayers\Badge::class,
            'progressBar' => \Kizi\Settings\Grid\Displayers\ProgressBar::class,
            'radio'       => \Kizi\Settings\Grid\Displayers\Radio::class,
            'checkbox'    => \Kizi\Settings\Grid\Displayers\Checkbox::class,
            'orderable'   => \Kizi\Settings\Grid\Displayers\Orderable::class,
        ];
