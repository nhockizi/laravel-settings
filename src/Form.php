...
use Kizi\Settings\Exception\Handle;
use Kizi\Settings\Form\Builder;
use Kizi\Settings\Form\Field;
use Kizi\Settings\Form\Field\File;
use Kizi\Settings\Form\Tab;
...
class Form
{
    ...
    {
        $map = [
            'button'         => \Kizi\Settings\Form\Field\Button::class,
            'checkbox'       => \Kizi\Settings\Form\Field\Checkbox::class,
            'color'          => \Kizi\Settings\Form\Field\Color::class,
            'currency'       => \Kizi\Settings\Form\Field\Currency::class,
            'date'           => \Kizi\Settings\Form\Field\Date::class,
            'dateRange'      => \Kizi\Settings\Form\Field\DateRange::class,
            'datetime'       => \Kizi\Settings\Form\Field\Datetime::class,
            'dateTimeRange'  => \Kizi\Settings\Form\Field\DatetimeRange::class,
            'datetimeRange'  => \Kizi\Settings\Form\Field\DatetimeRange::class,
            'decimal'        => \Kizi\Settings\Form\Field\Decimal::class,
            'display'        => \Kizi\Settings\Form\Field\Display::class,
            'divider'        => \Kizi\Settings\Form\Field\Divide::class,
            'divide'         => \Kizi\Settings\Form\Field\Divide::class,
            'embeds'         => \Kizi\Settings\Form\Field\Embeds::class,
            'editor'         => \Kizi\Settings\Form\Field\Editor::class,
            'email'          => \Kizi\Settings\Form\Field\Email::class,
            'file'           => \Kizi\Settings\Form\Field\File::class,
            'hasMany'        => \Kizi\Settings\Form\Field\HasMany::class,
            'hidden'         => \Kizi\Settings\Form\Field\Hidden::class,
            'id'             => \Kizi\Settings\Form\Field\Id::class,
            'image'          => \Kizi\Settings\Form\Field\Image::class,
            'ip'             => \Kizi\Settings\Form\Field\Ip::class,
            'map'            => \Kizi\Settings\Form\Field\Map::class,
            'mobile'         => \Kizi\Settings\Form\Field\Mobile::class,
            'month'          => \Kizi\Settings\Form\Field\Month::class,
            'multipleSelect' => \Kizi\Settings\Form\Field\MultipleSelect::class,
            'number'         => \Kizi\Settings\Form\Field\Number::class,
            'password'       => \Kizi\Settings\Form\Field\Password::class,
            'radio'          => \Kizi\Settings\Form\Field\Radio::class,
            'rate'           => \Kizi\Settings\Form\Field\Rate::class,
            'select'         => \Kizi\Settings\Form\Field\Select::class,
            'slider'         => \Kizi\Settings\Form\Field\Slider::class,
            'switch'         => \Kizi\Settings\Form\Field\SwitchField::class,
            'text'           => \Kizi\Settings\Form\Field\Text::class,
            'textarea'       => \Kizi\Settings\Form\Field\Textarea::class,
            'time'           => \Kizi\Settings\Form\Field\Time::class,
            'timeRange'      => \Kizi\Settings\Form\Field\TimeRange::class,
            'url'            => \Kizi\Settings\Form\Field\Url::class,
            'year'           => \Kizi\Settings\Form\Field\Year::class,
            'html'           => \Kizi\Settings\Form\Field\Html::class,
            'tags'           => \Kizi\Settings\Form\Field\Tags::class,
            'icon'           => \Kizi\Settings\Form\Field\Icon::class,
            'multipleFile'   => \Kizi\Settings\Form\Field\MultipleFile::class,
            'multipleImage'  => \Kizi\Settings\Form\Field\MultipleImage::class,
            'captcha'        => \Kizi\Settings\Form\Field\Captcha::class,
        ];
